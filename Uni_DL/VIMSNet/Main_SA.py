...
if __name__ == "__main__":   
    ...
    parser.add_argument('--model_type', default='VIMSNet_PSD', choices = ['VIMSNet', 'VIMSNet_PSD']) 
    ...
    parser.add_argument('--sr', default=128, help='sampling rate')
    parser.add_argument('--window_size', default=3, help='time window')
    ...
    if args.model_type == 'VIMSNet':
        from Models.VIMSNet_SA import VIMSNet
    elif args.model_type == 'VIMSNet_PSD':
        from Models.VIMSNet_SA_PSD import VIMSNet
