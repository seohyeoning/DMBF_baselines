...
if __name__ == "__main__": 
    ...
    parser.add_argument('--data_type', default='manD')
    ...
    parser.add_argument('--modality', default='ecg', choices=['eeg', 'ppg', 'eda', 'temp', 'ecg'])
    ...
    parser.add_argument('--freq_time', default=256*3, help='frequency(250)*time window(3)')
    parser.add_argument('--in_dim', default=[9], choices=[[9], [9,1], [9,1,1,1,1]], help='여기서는 사용 안함. 효과 x')
